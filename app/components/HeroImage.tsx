...
const HeroImage = () => {
  return (
    ...
    >
      <div className="hidden md:flex bg-red-500 p-10 rounded-full w-20 h-20 absolute top-14 -left-10"></div>
      <div className="hidden md:flex bg-red-500 p-10 rounded-full w-20 h-20 absolute bottom-20 left-96"></div>
      <div className="hidden md:flex bg-red-500 p-20 rounded-full w-44 h-44 absolute bottom-10 -right-20"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 sm:gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div className="">
            ...
            <div className="my-7 grid gap-3 w-full sm:inline-flex">
              <Link
                className="py-5 px-8 inline-flex text-lg justify-center items-center font-medium rounded-full text-white bg-red-600 hover:bg-red-700 focus:outline-none "
                href="#sejarah"
              >
                Mari Jelajahi
              </Link>
